...
static void test_sunday_basic(void)
{
    ...
    char pattern1[] = "world";
    assert(Sunday(source1, (int)strlen(source1), pattern1, (int)strlen(pattern1)) == 7);

    char source2[] = "GitHub Copilot";
    char pattern2[] = "Copilot";
    assert(Sunday(source2, (int)strlen(source2), pattern2, (int)strlen(pattern2)) == 7);

    char source3[] = "abcabcabc";
    char pattern3[] = "abc";
    assert(Sunday(source3, (int)strlen(source3), pattern3, (int)strlen(pattern3)) == 0);

    char source4[] = "abcabcabc";
    char pattern4[] = "def";
    assert(Sunday(source4, (int)strlen(source4), pattern4, (int)strlen(pattern4)) == -1);
}
